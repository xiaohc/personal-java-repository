...
public final class Check {
     ...
     * @return 校验处理
     */
    public static <T> ICheckHandle haveError(T t, Class<?>... groups) {
     ...
     */
    public static ICheckHandle isTrue(final boolean expression) {
        return error -> {
            if (expression) {
     ...
     */
    public static ICheckHandle isNull(final Object object) {
        return error -> {
            if (object == null) {
     ...
     */
    public static ICheckHandle notNull(final Object object) {
        return error -> {
            if (object != null) {
     ...
     */
    public static ICheckHandle isBlank(final String text) {
        return error -> {
     ...
     */
    public static ICheckHandle isNotBlank(final String text) {
        return error -> {
     ...
     */
    public static ICheckHandle isEmpty(final Object object) {
        return error -> {
     ...
     */
    public static ICheckHandle notEmpty(final Object object) {
        return error -> {
            if (!ObjectUtils.isEmpty(object)) {
                throw ensureToException(error, object).toException();
            }
